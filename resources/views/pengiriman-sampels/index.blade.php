                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <form action="{{ route('pengiriman-sampels.destroy', $pengiriman->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Anda akan menghapus <strong>semua data pengiriman sampel</strong> (total: {{ $pengirimanSampels->count() }} data).</p>
