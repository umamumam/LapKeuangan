                        ...
                        <form action="{{ route('pengiriman-sampels.update', $pengirimanSampel->id) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control @error('tanggal') is-invalid @enderror"
                                            ...
                                            value="{{ old('tanggal', $pengirimanSampel->tanggal->format('Y-m-d\TH:i')) }}" required>
                                        @error('tanggal')
                                        ...
                                        <select class="form-control @error('sampel_id') is-invalid @enderror"
                                            ...
                                            @foreach($sampels as $sampel)
                                                <option value="{{ $sampel->id }}"
                                                    ...
                                                    {{ old('sampel_id', $pengirimanSampel->sampel_id) == $sampel->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('jumlah') is-invalid @enderror"
                                            ...
                                            value="{{ old('jumlah', $pengirimanSampel->jumlah) }}" min="1" required onchange="calculateTotal()">
                                        @error('jumlah')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('no_resi') is-invalid @enderror"
                                            ...
                                            value="{{ old('no_resi', $pengirimanSampel->no_resi) }}" required>
                                        @error('no_resi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('ongkir') is-invalid @enderror"
                                            ...
                                            value="{{ old('ongkir', $pengirimanSampel->ongkir) }}" min="0" required onchange="calculateTotal()">
                                        @error('ongkir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control bg-light" id="totalhpp_display">
                                            Rp {{ number_format($pengirimanSampel->totalhpp, 0, ',', '.') }}
                                        </div>
                                        <input type="hidden" id="totalhpp" name="totalhpp" value="{{ $pengirimanSampel->totalhpp }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control bg-light fw-bold" id="total_biaya_display">
                                            Rp {{ number_format($pengirimanSampel->total_biaya, 0, ',', '.') }}
                                        </div>
                                        <input type="hidden" id="total_biaya" name="total_biaya" value="{{ $pengirimanSampel->total_biaya }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('penerima') is-invalid @enderror"
                                            ...
                                            value="{{ old('penerima', $pengirimanSampel->penerima) }}" required>
                                        @error('penerima')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('contact') is-invalid @enderror"
                                            ...
                                            value="{{ old('contact', $pengirimanSampel->contact) }}" required>
                                        @error('contact')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror"
                                    id="alamat" name="alamat" rows="3" required>{{ old('alamat', $pengirimanSampel->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
