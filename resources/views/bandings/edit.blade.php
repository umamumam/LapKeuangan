                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('marketplace') is-invalid @enderror"
                                            ...
                                            <option value="{{ $value }}" {{ old('marketplace', $banding->marketplace) ==
                                                $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('no_pesanan', $banding->no_pesanan) }}" required>
                                        @error('no_pesanan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('status_banding') is-invalid @enderror"
                                            ...
                                            <option value="{{ $value }}" {{ old('status_banding', $banding->
                                                status_banding) == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('alasan') is-invalid @enderror" id="alasan"
                                            ...
                                            <option value="{{ $value }}" {{ old('alasan', $banding->alasan) == $value ?
                                                'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('ongkir') is-invalid @enderror" id="ongkir"
                                            ...
                                            <option value="{{ $value }}" {{ old('ongkir', $banding->ongkir) == $value ?
                                                'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('username') is-invalid @enderror"
                                            ...
                                            value="{{ old('username', $banding->username) }}" required>
                                        @error('username')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_pengirim', $banding->nama_pengirim) }}" required>
                                        @error('nama_pengirim')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
